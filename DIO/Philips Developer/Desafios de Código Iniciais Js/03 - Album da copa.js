 ...
 let nFigurinhasPacote = parseInt(gets())
 let nFigurinhasFaltantes = parseInt(gets())
 let album = [];
 
 for (let i = 0; i < nFigurinhasFaltantes; i++) {
 ...
 console.log(nFigurinhasPacote - album.length)
